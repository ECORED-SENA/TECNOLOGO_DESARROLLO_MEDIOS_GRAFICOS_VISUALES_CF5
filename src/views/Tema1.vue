...
export default {
  ...
  data: () => ({
    datosSlyder: [
      {
        titulo: 'Proceso de la producción gráfica',
        texto:
          'En una primera fase comprendida como el proceso creativo, se pueden definir las ideas que darán sentido y serán las que orientarán el proyecto, en esta primera etapa se encuentra la planificación que será la encargada de combinar todas las ideas con las que se comenzará el proceso. ',
        imagen: require('@/assets/curso/3.jpg'),
      },
      {
        titulo: '1. Planificación Estratégica',
        texto:
          'Al momento de iniciar una planificación, se debe planificar una junta con el cliente y con todos los elementos humanos que participarán en este proceso; en este proceso se completará el Brief y se recibirán todas las indicaciones que se deben seguir al momento de la creación de conceptos y líneas creativas que serán las encargadas de darle sentido a todo el proceso de producción, en esta fase se conocerán objetivos principales, el target objetivo y los elementos de salida; toda esta información se incluirá en un cronograma de actividades, se estipularán fechas de entregas parciales y las fechas finales. ',
        imagen: require('@/assets/curso/4.jpg'),
      },
      {
        titulo: 'Propuesta Creativa',
        texto:
          'Una vez conocidas las necesidades y los objetivos   entregados por el brief, se comenzará la fase de la creación de la propuesta creativa por parte del diseñador y todo el equipo creativo, donde se expondrán diferentes caminos creativos los que estarán apoyados en el información contenida en dicho brief, acá se definirán características más técnicas, se presentarán bocetos y diseños, características de packaging y sus acabados, al igual de se definirán características o paletas de color y en general toda la información que pueda orientar mejor el proyecto para poder definir presupuestos.<br><br>Al finalizar esta fase se obtienen conceptos de diseño claros que estarán en constante revisión con el cliente, quien será el encargado de dar el visto bueno, para así poder pasar a una fase de realización. ',
        imagen: require('@/assets/curso/5.jpg'),
      },
      {
        titulo: 'Finalización propuesta creativa',
        texto:
          'Al finalizar esta fase se obtienen conceptos de diseño claros que estarán en constante revisión con el cliente, quien será el encargado de dar el visto bueno, para así poder pasar a una fase de realización.',
        imagen: require('@/assets/curso/6.jpg'),
      },
      {
        titulo: '2. Finalización del proceso de producción',
        texto:
          'En una segunda instancia,  teniendo definidos los formatos, los materiales a utilizar, los acabados y toda la información que se ha contenido en la fase anterior, es necesario dar paso a la fase de finalización del proceso de producción, es importante que las personas que hacen parte de los procesos, den indicaciones con las especificaciones necesarias, pará así hacer los respectivos controles y verificaciones de calidad, las impresiones finales y las entregas pactadas. ',
        imagen: require('@/assets/curso/7.jpg'),
      },
      {
        titulo: 'Realización de artes finales',
        texto:
          'Una vez encontrado el camino creativo y la aprobación del cliente se pasa a un proceso de bocetación y entrega de artes o piezas finales, las cuales en esta época se realizan con programas o software como lo son InDesign, PhotoShop o Illustrator, este último programa será el que tendremos presente para la creación de ilustraciones y elementos a partir de vectores. <br><br>Este proceso deberá incluir especificaciones como los perfiles de color, las líneas de corte y otras características que se deberán tener presentes como lo son las tipografías o la resolución de las imágenes, elementos que se deberán chequear y tener presentes al momento del paso de los archivos a los impresores. ',
        imagen: require('@/assets/curso/8.jpg'),
      },
      {
        titulo: 'Pruebas de color',
        texto:
          'Antes de empezar el proceso de impresión, es importante realizar unas pruebas de color, que serán las encargadas de no echar a perder todo el trabajo que se realizará al momento de imprimir. <br><br>Estas, son unas pruebas que el impresor entrega al diseñador para que se verifiquen y supervisen que todos los colores concuerden con sus gamas tonales, sus brillos y demás características que el diseñador debe detectar como errores, los cuales deberán solucionarse antes de pasar al proceso de impresión final.',
        imagen: require('@/assets/curso/9.jpg'),
      },
      {
        titulo: 'Impresión',
        texto:
      ...
      },
      {
        titulo: 'Acabados',
        texto:
          'Algunos de los elementos que están una vez impresos necesitan acabados como lo pueden ser plastificaciones, troqueles, hendidos, estampaciones y otros procesos o acabados de calidad que le darán un toque de distinción a los proyectos realizados, dándole características que ayudarán a mejorar el elemento.<br><br>Otros procesos de acabado se deben realizar manualmente y requiere contemplar otro proceso y es la manipulación del producto, como el doblado, la encuadernación, los troquelados y los guillotinados. ',
        imagen: require('@/assets/curso/11.jpg'),
      },
      {
